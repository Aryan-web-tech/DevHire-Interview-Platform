 ...
 * @export
 */
export declare const AudioSettingsResponseDefaultDeviceEnum: {
    readonly SPEAKER: "speaker";
    readonly EARPIECE: "earpiece";
};
 ...
 * @export
 */
export declare const CreateDeviceRequestPushProviderEnum: {
 ...
 * @export
 */
export declare const FrameRecordingSettingsRequestModeEnum: {
 ...
 * @export
 */
export declare const FrameRecordingSettingsResponseModeEnum: {
    readonly AVAILABLE: "available";
    readonly DISABLED: "disabled";
    readonly AUTO_ON: "auto-on";
};
export type FrameRecordingSettingsResponseModeEnum = (typeof FrameRecordingSettingsResponseModeEnum)[keyof typeof FrameRecordingSettingsResponseModeEnum];
/**
 *
 * @export
 ...
 * @export
 */
export declare const IngressSourceRequestFpsEnum: {
    readonly NUMBER_30: 30;
    readonly NUMBER_60: 60;
};
export type IngressSourceRequestFpsEnum = (typeof IngressSourceRequestFpsEnum)[keyof typeof IngressSourceRequestFpsEnum];
/**
 *
 * @export
...
export interface ParticipantSeriesPublisherStats {
     ...
     */
    global_thresholds?: {
        [key: string]: Array<MetricThreshold>;
    };
    /**
     *
     ...
     */
    tracks?: {
        [key: string]: Array<ParticipantSeriesTrackMetrics>;
    };
}
/**
 *
 ...
 * @export
 */
export declare const RTMPBroadcastRequestQualityEnum: {
    readonly _360P: "360p";
    readonly _480P: "480p";
    readonly _720P: "720p";
    readonly _1080P: "1080p";
 ...
 * @export
 */
export declare const RTMPSettingsRequestQualityEnum: {
    readonly _360P: "360p";
    readonly _480P: "480p";
    readonly _720P: "720p";
    readonly _1080P: "1080p";
 ...
 * @export
 */
export declare const TranscriptionSettingsRequestLanguageEnum: {
    readonly AUTO: "auto";
    readonly EN: "en";
    readonly FR: "fr";
    readonly ES: "es";
 ...
 * @export
 */
export declare const TranscriptionSettingsRequestModeEnum: {
    readonly AVAILABLE: "available";
    readonly DISABLED: "disabled";
    readonly AUTO_ON: "auto-on";
};
 ...
 * @export
 */
export declare const TranscriptionSettingsResponseLanguageEnum: {
    readonly AUTO: "auto";
    readonly EN: "en";
    readonly FR: "fr";
    readonly ES: "es";
 ...
 * @export
 */
export declare const TranscriptionSettingsResponseModeEnum: {
    readonly AVAILABLE: "available";
    readonly DISABLED: "disabled";
    readonly AUTO_ON: "auto-on";
};
 ...
 * @export
 */
export declare const VideoSettingsRequestCameraFacingEnum: {
 ...
 * @export
 */
export declare const VideoSettingsResponseCameraFacingEnum: {
    readonly FRONT: "front";
    readonly BACK: "back";
    readonly EXTERNAL: "external";
};
