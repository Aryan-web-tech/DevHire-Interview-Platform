...
const StreamI18nProvider = ({ children, ...createI18nParams }) => {
    ...
    return (jsxRuntime.jsx(StreamI18nContext.Provider, { value: api, children: children }));
};
const useCreateI18n = ({ i18nInstance, language, fallbackLanguage, translationsOverrides, }) => {
    ...
    const [t, setTranslationFn] = react.useState(() => i18n.t);
    react.useEffect(() => {
    ...
    return react.useMemo(() => ({ i18n, t }), [i18n, t]);
};
/**
